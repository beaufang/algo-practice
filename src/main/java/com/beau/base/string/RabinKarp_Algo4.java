...
public class RabinKarp_Algo4 {
     ...
     */
    public RabinKarp_Algo4(char[] pattern, int R) {
     ...
     */
    public RabinKarp_Algo4(String pat) {
    ...
    public static void main(String[] args) {
        ...
        RabinKarp_Algo4 searcher = new RabinKarp_Algo4(pat);
